#define BUZZER_PIN    12 // пин с пищалкой (англ. «buzzer»)
#define FIRST_KEY_PIN 5  // первый пин с клавишей (англ. «key»)
#define KEY_COUNT     4  // общее количество клавиш
////////JqJq
int note[KEY_COUNT] = {698, 659, 587, 523};
...
void loop()
{
  // в цикле бежим по всем номерам кнопок, от 0-го по 3-й
