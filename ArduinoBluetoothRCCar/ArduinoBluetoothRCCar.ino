...
//Original App - https://play.google.com/store/apps/details?id=braulio.calle.bluetoothRCcontroller
...
void control()  // функция управления
{
  ...
  else if (((dataIn - '0') >= 0) && ((dataIn - '0') <= 9)) // если к нам пришло значение от 0 до 9
